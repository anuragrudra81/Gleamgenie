      ...
      <div className="container grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="flex flex-col gap-4">
          <Link href="/" className="flex items-center gap-2" prefetch={false}>
            ...
            <span className="font-bold text-xl tracking-widest">gleam genie</span>
          </Link>
        ...
        <div className="grid gap-2">
          <h4 className="font-light tracking-wider">quick links</h4>
        ...
        <div className="grid gap-2">
          <h4 className="font-light tracking-wider">contact us</h4>
        ...
        <div className="grid gap-2">
          <h4 className="font-light tracking-wider">follow us</h4>
