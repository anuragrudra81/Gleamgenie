        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col justify-center space-y-6 animate-fade-in-up text-left">
            ...
            <p className="text-muted-foreground font-light max-w-lg">
              Post-construction cleanup requires a special level of attention. Our construction cleaning service is designed to handle the dust, debris, and residue left behind after a renovation or new build. We provide a thorough, top-to-bottom clean that makes the property shine and ready for its new occupants. From detailed vacuuming to polishing surfaces, we ensure every corner is spotless.
            </p>
            <div className="pt-4">
