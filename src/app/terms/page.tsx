    ...
    <div className="container mx-auto px-4 py-16 pt-32 sm:pt-48">
      ...
      <div className="prose prose-lg text-foreground max-w-4xl mx-auto">
        <p className="text-center">
          These Terms and Conditions apply to all cleaning services provided by Gleam Genie, By booking a service, the client agrees to the terms below.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-2xl font-bold mt-6 mb-3 text-primary">2, CANCELLATIONS AND RESCHEDULING</h2>
            <ul className="list-disc pl-6 space-y-2 font-light">
          ...
          <div>
            <h2 className="text-2xl font-bold mt-6 mb-3 text-primary">4, QUALITY AND COMPLAINTS</h2>
            <ul className="list-disc pl-6 space-y-2 font-light">
          ...
          <div>
            <h2 className="text-2xl font-bold mt-6 mb-3 text-primary">5, ACCESS AND SECURITY</h2>
            <ul className="list-disc pl-6 space-y-2 font-light">
          ...
          <div>
            <h2 className="text-2xl font-bold mt-6 mb-3 text-primary">6, PRICING AND ESTIMATES</h2>
            <ul className="list-disc pl-6 space-y-2 font-light">
          ...
          <div>
            <h2 className="text-2xl font-bold mt-6 mb-3 text-primary">7, SAFETY AND LIMITATIONS</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mt-6 mb-3 text-primary">8, DAMAGE AND BREAKAGE</h2>
            <ul className="list-disc pl-6 space-y-2 font-light">
          ...
          <div>
            <h2 className="text-2xl font-bold mt-6 mb-3 text-primary">10, PHOTOS AND EVIDENCE</h2>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 font-light">
              ...
              <li>terms and conditions are repeatedly breached</li>
            </ul>
          </div>
        </div>
      </div>
