...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto px-4 py-16 pt-32 sm:pt-48">
      <h1 className="text-4xl font-bold mb-4 text-primary">Privacy Policy – Gleam Genie</h1>
      <div className="prose prose-lg text-foreground max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2 text-primary">What We Collect</h2>
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2 text-primary">How We Use It</h2>
        <ul className="list-disc pl-6 space-y-2 font-light">
          <li>To provide cleaning services and send booking updates</li>
          <li>To communicate with you about your service</li>
        </ul>

        <h2 className="text-2xl font-bold mt-6 mb-2 text-primary">Sharing Your Information</h2>
        <ul className="list-disc pl-6 space-y-2 font-light">
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2 text-primary">Your Rights</h2>
        <ul className="list-disc pl-6 space-y-2 font-light">
