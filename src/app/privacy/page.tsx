  ...
  return (
    <div className="container mx-auto px-4 py-16 pt-32 sm:pt-48">
      ...
      <div className="prose prose-lg text-foreground">
        <p>
          Your privacy is important to us. It is Gleam Genie's policy to respect your privacy regarding any
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2 text-primary">Information We Collect</h2>
        <p>
          Log data: Like many site operators, we collect information that your browser sends whenever you visit
          our Site. This Log Data may include information such as your computer's Internet Protocol ("IP")
        ...
        <p>
          Personal Information: We may ask you to provide us with certain personally identifiable information
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2 text-primary">Security</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2 text-primary">Changes to This Privacy Policy</h2>
        <p>
          This Privacy Policy is effective as of the last updated date and will remain in effect except with
